...
def merge_frames_with_audio(audio_path, fps = 25):
    ...
    logger.info(f"[Real-time Inference] Merging frames with audio on {video_idx}")
    ...
    logger.info(f"[Real-time Inference] Merging frames with audio costs {time.time()-start_time}s")
    return video_path
